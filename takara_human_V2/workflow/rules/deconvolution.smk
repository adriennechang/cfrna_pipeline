rule BP_decon:
    ...
    output:
        ...
        celltype_frac_pc_sig = OUTPUT + '{project}/sample_output/{sample}/{sample}_BP_celltypes.protein_coding.marker_genes.tsv'
    params:
    ...
    shell:
        """
        Rscript {params.decon_script} {input.counts} {params.decon_ref} {params.decon_meta} {params.biotype_key} {output.celltype_frac} {output.celltype_frac_pc} {output.celltype_frac_pc_sig} {threads} {wildcards.sample}
        """
