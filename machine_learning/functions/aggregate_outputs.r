...
COMPARE_OUTPUTS <- function(FILE_NAME){
    ...
    tmp_plt <- df_train_m %>%
        ...
        mutate(stat = factor(stat, levels = c("Specificity","Sensitivity","Accuracy"))) %>%
...
#         scale_size_manual(values=c(1,1.5))+
    ...
    ggsave(paste0("output/",FILE_NAME,"/",FILE_NAME,"_dotplot.comparison.png"), tmp_plt, height=12,width=4)
